...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld)
        payable
        ERC721("Ethernals Name Service", "ENS")
    {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Ethernals name service", "image": "data:image/svg+xml;base64,',
    ...
    function setRecord(string calldata name, string calldata record) public {
        ...
        require(domains[name] == msg.sender, "Only owner is allowed");
        records[name] = record;
    }
